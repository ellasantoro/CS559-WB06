...
//calculate by using 0.5 * box_height and then add all previous box heights to that:
//FOR MY REFERENCE:
//box1 height: 2
//box2 height: 1.5
//box3 height: 1
//box4 height: 0.8
//box5 height: 0.5
box1.position.y = 1; //0.5 * 2 = 1
box2.position.y = 2.75; //(0.5 * 1.5) + 2
box3.position.y = 4; //(0.5)(1) + 1.5 + 2
box4.position.y = 4.9; //(0.5)(0.8) + 1 + 1.5 + 2
box5.position.y = 5.55; //(0.5)(0.5) + 0.8 + 1 + 1.5 + 2
